...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $book->setCover('http://www.tutsyk.ru/upload/iblock/66b/66b3605bcdb0361f002fc119d5e4c472.jpg');
        $book->setDateAdded(new \DateTime('now'));
        $book->setUser($user);
        ...
        $book->setCover('https://multi-boom.ru/upload/iblock/980/980033064cb852f9a94dd7f4c94df961.jpeg');
        $book->setDateAdded(new \DateTime('now'));
        $book->setUser($user);
        $manager->persist($book);
        ...
        $book->setCover('https://knigozor54.ru/upload/iblock/9b0/qgi85w70utgal05iea0xqk7n75j3dcfh.jpeg');
        $book->setDateAdded(new \DateTime('now'));
        $book->setUser($user);
        $manager->persist($book);
        ...
        $book->setCover('https://multi-boom.ru/upload/iblock/11e/11e1781f86cd9580f340b7f865d2aca3.jpeg');
        $book->setDateAdded(new \DateTime('now'));
        $book->setUser($user);
        $manager->persist($book);
